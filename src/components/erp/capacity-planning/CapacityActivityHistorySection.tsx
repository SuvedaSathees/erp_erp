...
import type { CapacityAuditEntry } from "@/services/types";

export function CapacityActivityHistorySection({
  activities,
}: {
  activities: CapacityAuditEntry[];
}) {
  return (
    <Card className="border-border/80 shadow-xs bg-white dark:bg-slate-900">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs">
          Immutable audit log capturing capacity updates, demand changes, simulation executions & sign-offs.
        </CardDescription>
      </CardHeader>
