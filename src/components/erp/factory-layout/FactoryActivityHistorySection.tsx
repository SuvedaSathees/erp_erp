...
import type { FactoryAuditEntry } from "@/services/types";

export function FactoryActivityHistorySection({
  activities,
}: {
  activities: FactoryAuditEntry[];
}) {
  return (
    <Card className="border-border/80 shadow-xs bg-white dark:bg-slate-900">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs">
          Immutable audit trail capturing layout design changes, simulation runs, CAD uploads & executive sign-offs.
        </CardDescription>
      </CardHeader>
