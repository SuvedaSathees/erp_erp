...
import { History, User, Clock, CheckCircle2, FileText, Activity } from "lucide-react";
import type { JigAuditEntry } from "@/services/types";

export function JigActivityHistorySection({
  activities,
}: {
  activities: JigAuditEntry[];
}) {
  return (
    <Card className="border-border/80 shadow-xs bg-white dark:bg-slate-900">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs">
          Immutable audit trail capturing user actions, draft saves, uploads, validation scores, and workflow transitions.
        </CardDescription>
      </CardHeader>
