      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        ...
        <div className="space-y-1 min-w-0">
          ...
          <div className="flex items-center gap-3 text-xs text-muted-foreground">
            <span>Product: <strong className="text-foreground">{record.linkedProduct?.name || "EV Charger AC"}</strong></span>
            <span>•</span>
            <span>Engineer: <strong className="text-foreground">{record.jigDesignEngineer?.name || "Rahul Sharma"}</strong></span>
            <span>•</span>
