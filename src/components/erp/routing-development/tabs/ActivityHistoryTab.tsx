    ...
    <div className="space-y-6 text-xs">
      <div className="bg-card p-4 rounded-lg border border-border space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div>
            <span className="text-muted-foreground block text-[10px] uppercase font-semibold">Routing Version</span>
            <span className="font-extrabold text-emerald-600 dark:text-emerald-400">v{record.routingVersion}</span>
          </div>
        </div>
      </div>
