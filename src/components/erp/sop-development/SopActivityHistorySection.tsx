...
import type { SopAuditEntry } from "@/services/types";

export function SopActivityHistorySection({
  activities,
}: {
  activities: SopAuditEntry[];
}) {
  return (
    <Card className="border-border/80 shadow-xs bg-white dark:bg-slate-900">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs">
          Immutable audit log capturing SOP revisions, procedure updates, ISO compliance sign-offs & executive decisions.
        </CardDescription>
      </CardHeader>
