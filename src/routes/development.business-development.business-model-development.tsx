  ...
  return (
    ...
    >
      <div className="space-y-6 text-foreground">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  BM ID: <span className="font-mono font-bold text-foreground">{formData.businessModelId}</span> · Code:{" "}
        ...
        {/* Main Content: Continuous Vertical Canvas */}
        <div className="w-full space-y-6">
          {/* Value Proposition & Strategic Scope */}
          <div id="sec-value-proposition" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <Target className="h-4 w-4 text-emerald-600" /> Value Proposition & Strategic Scope
              </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 lg:grid-cols-6 rounded-lg border border-border bg-muted/10 p-3">
                <div>
                  <label className="flex items-center justify-between text-[11px] font-semibold text-muted-foreground mb-1">
                    <span>Category</span> <MAICWBadge type="M" />
                  </label>
                  <select
                    value={formData.category}
                    onChange={(e) => updateField("category", e.target.value)}
                    className={cn(
                      "w-full rounded-lg border bg-card px-2.5 py-1.5 text-xs text-foreground focus:border-primary focus:outline-none",
                  ...
                  {validationErrors.category && <p className="text-[9px] text-rose-500 mt-0.5">{validationErrors.category}</p>}
                </div>

                <div>
                  <label className="flex items-center justify-between text-[11px] font-semibold text-muted-foreground mb-1">
                    <span>Type</span> <MAICWBadge type="M" />
                  </label>
                  <select
                    value={formData.type}
                  ...
                  {validationErrors.type && <p className="text-[9px] text-rose-500 mt-0.5">{validationErrors.type}</p>}
                </div>
                ...
                <div>
                  ...
                  />
                  {validationErrors.industry && <p className="text-[9px] text-rose-500 mt-0.5">{validationErrors.industry}</p>}
                </div>

                <div>
                  <label className="flex items-center justify-between text-[11px] font-semibold text-muted-foreground mb-1">
                    <span>Lifecycle</span> <MAICWBadge type="W" />
                  </label>
                  <select
                ...
                <div>
                  <label className="flex items-center justify-between text-[11px] font-semibold text-muted-foreground mb-1">
                    <span>Status</span> <MAICWBadge type="W" />
                  </label>
                  <select
          ...
          <div id="sec-customer-market" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <Users className="h-4 w-4 text-indigo-600" /> Customer & Market Analysis
              </h3>
          ...
          <div id="sec-revenue-model" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <DollarSign className="h-4 w-4 text-emerald-600" /> Revenue Model & Unit Economics
              </h3>
          ...
          <div id="sec-cost-structure" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <Layers className="h-4 w-4 text-amber-500" /> Cost Structure & Financial Breakdown
              </h3>
          ...
          <div id="sec-operations" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <Cpu className="h-4 w-4 text-blue-600" /> Key Operations & Resources
              </h3>
          ...
          <div id="sec-growth-scalability" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <TrendingUp className="h-4 w-4 text-purple-600" /> Growth & Scalability
              </h3>
          ...
          <div id="sec-risk-compliance" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-rose-500" /> Risk & Regulatory Compliance
              </h3>
          ...
          <div id="sec-summary" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <Award className="h-4 w-4 text-emerald-600" /> Executive Business Model Summary & Strategic Decision
              </h3>
              <span className="text-xs font-bold text-emerald-600">Model Rating: {computedOverallScore}/100 (Tier 1)</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
              <div className="rounded-xl border border-border bg-muted/10 p-4 space-y-2 text-xs">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  All 9 Canvas components meet ERP governance thresholds with validated TAM ($120B), 72.5% projected gross margins, and active IP protections.
                </p>
              </div>
          ...
          <div id="sec-attachments" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <FileText className="h-4 w-4 text-primary" /> Business Model Attachments & Artifacts
              </h3>
              <button
                type="button"
          ...
          <div id="sec-activity-history" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                <History className="h-4 w-4 text-primary" /> Business Model Activity History Log
              </h3>
