...
import { businessScalingService } from "@/services/businessScalingService";
...
function BusinessScalingDevelopmentPage() {
  ...
  const { data: loadedRecord, isLoading: isRecordLoading } = useQuery({
    queryKey: ["business-scaling"],
    queryFn: businessScalingService.fetchRecord,
  });
  ...
  if (isRecordLoading || !formData) {
    return (
      <AppShell title="Business Scaling Development" breadcrumb={[{ label: "Business Development" }, { label: "Business Scaling Development" }]}>
