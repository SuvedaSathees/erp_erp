...
export function InvestorRelationsDevelopmentPage() {
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div id="sec-overview" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Building2 className="h-4 w-4 text-primary" /> 1. Investor Relations Overview
                </h3>
            ...
            <div id="sec-investor-profile" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Users className="h-4 w-4 text-emerald-600" /> 2. Investor Profile & Preferences
                </h3>
            ...
            {/* 3. Fundraising Opportunity Assessment */}
            <div id="sec-assessment" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Target className="h-4 w-4 text-purple-600" /> 3. Fundraising Opportunity Assessment
                </h3>
            ...
            <div id="sec-engagement" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Handshake className="h-4 w-4 text-blue-600" /> 4. Investor Engagement & Pipeline
                </h3>
            ...
            <div id="sec-financial-compliance" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Scale className="h-4 w-4 text-emerald-600" /> 5. Financial Modeling & Governance Compliance
                </h3>
                <span className="text-xs font-semibold text-emerald-600 flex items-center gap-1">
            ...
            <div id="sec-negotiation" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <DollarSign className="h-4 w-4 text-emerald-600" /> 6. Term Sheet & Valuation Negotiation
                </h3>
            ...
            <div id="sec-communication" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <MessageSquare className="h-4 w-4 text-purple-600" /> 7. Post-Investment Stakeholder Communication
                </h3>
                <span className="text-xs font-semibold text-purple-600 flex items-center gap-1">
            ...
            <div id="sec-ai-intelligence" className="rounded-xl border border-primary/30 bg-gradient-to-b from-primary/5 via-card to-card p-5 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5">
                    <Target className="h-3.5 w-3.5 text-emerald-600" /> AI Investor Match
                  </span>
                  <p className="text-muted-foreground leading-relaxed">{formData.aiInvestorMatch}</p>
                </div>
                ...
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5 text-emerald-600">
                    <ShieldCheck className="h-3.5 w-3.5" /> AI Negotiation Insights
                  </span>
                  <p className="text-muted-foreground leading-relaxed">{formData.aiNegotiationInsights}</p>
                </div>
              </div>
              ...
              >
                <Sparkles className="h-4 w-4" /> Open Interactive AI Investor Intelligence Workbench <ChevronRight className="h-4 w-4" />
              </button>
            </div>

            {/* 9. Investor Relations Summary */}
            <div id="sec-summary" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Award className="h-4 w-4 text-emerald-600" /> 9. Investor Relations Summary & Recommendation
                </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-xs font-semibold">
                    ...
                    <span className="font-mono font-bold">{formData.investorFitScore} / 100</span>
                  </div>
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-emerald-600 rounded-full" style={{ width: `${formData.investorFitScore}%` }} />
                  </div>

                  <div className="flex items-center justify-between text-xs font-semibold">
                    <span>Assessment Score</span>
                    <span className="font-mono font-bold">{formData.assessmentScore} / 100</span>
                  </div>
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-blue-600 rounded-full" style={{ width: `${formData.assessmentScore}%` }} />
                  </div>
                  ...
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-purple-600 rounded-full" style={{ width: `${formData.financialReadinessScore}%` }} />
                  </div>

                  <div className="flex items-center justify-between text-xs font-semibold">
                    <span>Negotiation Score</span>
                    <span className="font-mono font-bold">{formData.negotiationScore} / 100</span>
                  </div>
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-amber-500 rounded-full" style={{ width: `${formData.negotiationScore}%` }} />
                  </div>

                  <div className="flex items-center justify-between text-xs font-semibold">
                    <span>AI Investor Score</span>
                    <span className="font-mono font-bold">{formData.aiInvestorScore} / 100</span>
                  </div>
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-primary rounded-full" style={{ width: `${formData.aiInvestorScore}%` }} />
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center p-4 border border-border rounded-xl bg-muted/20 text-center space-y-3">
                  <ScoreGauge label="Overall IR Readiness" score={computedOverallScore} sub="Very Good" size="large" />
            ...
            <div id="sec-attachments" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <FileText className="h-4 w-4 text-primary" /> 10. Investor Data Room & Attachments
                </h3>
                <button
                  type="button"
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-primary/20 bg-gradient-to-b from-primary/5 via-card to-card p-5 shadow-xs space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5">
                    <Target className="h-3.5 w-3.5 text-blue-600" /> Investor Match
                  </span>
                  <p className="text-muted-foreground leading-relaxed">
                    Alpha Growth Ventures shows 87% match with your investment criteria.
                  </p>
                </div>

                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5">
                    <TrendingUp className="h-3.5 w-3.5 text-emerald-600" /> Funding Probability
                  </span>
                  <p className="text-muted-foreground leading-relaxed">
                    AI predicts 76% probability of successful funding based on current traction.
                  </p>
                </div>

                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5 text-indigo-600">
                    <DollarSign className="h-3.5 w-3.5" /> Valuation Benchmark
                  </span>
                  <p className="text-muted-foreground leading-relaxed">
                    Comparable valuation range between ₹ 620 Cr - ₹ 680 Cr.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Strengthen unit economics section in financial model.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Capital Requirement</span>
                ...
                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Funding Probability</span>
                    <Sparkline data={[60, 68, 72, 76]} color="#10b981" />
                  </div>
                  <span className="text-base font-bold text-emerald-600 font-mono block">76 %</span>
                </div>

                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Investor Fit</span>
                    <Sparkline data={[75, 80, 84, 87]} color="#2563eb" />
                  </div>
                  <span className="text-base font-bold text-indigo-600 font-mono block">87 / 100</span>
                </div>

                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Engagement Score</span>
                    <Sparkline data={[70, 74, 78, 81]} color="#10b981" />
                  </div>
                  <span className="text-base font-bold text-emerald-600 font-mono block">81 / 100</span>
                </div>

                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Financial Readiness</span>
                    <Sparkline data={[72, 76, 80, 84]} color="#10b981" />
                  </div>
                ...
                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Negotiation Score</span>
                    <Sparkline data={[65, 70, 74, 78]} color="#2563eb" />
                  </div>
                  <span className="text-base font-bold text-amber-500 font-mono block">78 / 100</span>
                </div>
              </div>

              <button
                type="button"
                onClick={() => showToast("info", "KPI Dashboard", "Navigating to IR KPI Dashboard...")}
            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-3 text-xs">
              ...
              <div className="space-y-1.5 text-muted-foreground">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-foreground">{formData.investorRelationsManager}</span>
                </div>
                <div className="flex justify-between">
                  <span>Created Date:</span>
                  <span className="font-semibold text-foreground">05 May 2024 09:45 AM</span>
                </div>
                <div className="flex justify-between">
