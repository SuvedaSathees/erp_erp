...
export function PartnershipDevelopmentPage() {
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div id="sec-overview" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Building2 className="h-4 w-4 text-primary" /> 1. Partnership Overview
                </h3>
            ...
            <div id="sec-partner-profile" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Building2 className="h-4 w-4 text-emerald-600" /> 2. Partner Organization Profile
                </h3>
            ...
            <div id="sec-partner-evaluation" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Star className="h-4 w-4 text-purple-600" /> 3. Partnership Evaluation & Due Diligence
                </h3>
            ...
            <div id="sec-operational-integration" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <CheckSquare className="h-4 w-4 text-blue-600" /> 5. Operational Integration & Governance
                </h3>
            ...
            <div id="sec-risk-compliance" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <AlertTriangle className="h-4 w-4 text-amber-500" /> 6. Risk & Compliance Management
                </h3>
            ...
            <div id="sec-ai-intelligence" className="rounded-xl border border-primary/30 bg-gradient-to-b from-primary/5 via-card to-card p-5 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5">
                    <Handshake className="h-3.5 w-3.5 text-emerald-600" /> AI Partner Suitability
                  </span>
                  <p className="text-muted-foreground leading-relaxed">{formData.aiPartnerSuitability}</p>
                </div>

                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5">
                    <Zap className="h-3.5 w-3.5 text-blue-600" /> AI Synergy Analysis
                  </span>
                  <p className="text-muted-foreground leading-relaxed">{formData.aiSynergyAnalysis}</p>
                </div>

                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5">
                    <DollarSign className="h-3.5 w-3.5 text-purple-600" /> AI Revenue Opportunity
                  </span>
                ...
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5 text-emerald-600">
                    <Globe className="h-3.5 w-3.5" /> AI Expansion Strategy
                  </span>
                  <p className="text-muted-foreground leading-relaxed">{formData.aiExpansionStrategy}</p>
                </div>
              </div>
              ...
              >
                <Sparkles className="h-4 w-4" /> Open Interactive AI Partnership Intelligence Workbench <ChevronRight className="h-4 w-4" />
              </button>
            </div>
            ...
            <div id="sec-summary" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <Award className="h-4 w-4 text-emerald-600" /> 9. Partnership Summary & Executive Recommendation
                </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-xs font-semibold">
                    ...
                    <span className="font-mono font-bold">{formData.partnerCapabilityScore} / 100</span>
                  </div>
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-emerald-600 rounded-full" style={{ width: `${formData.partnerCapabilityScore}%` }} />
                  </div>

                  <div className="flex items-center justify-between text-xs font-semibold">
                    <span>Evaluation Score</span>
                    <span className="font-mono font-bold">{formData.evaluationScore} / 100</span>
                  </div>
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-blue-600 rounded-full" style={{ width: `${formData.evaluationScore}%` }} />
                  </div>
                  ...
                  <div className="flex items-center justify-between text-xs font-semibold">
                    ...
                    <span className="font-mono font-bold">{formData.aiPartnershipScore} / 100</span>
                  </div>
                  <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
                    <div className="h-full bg-primary rounded-full" style={{ width: `${formData.aiPartnershipScore}%` }} />
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center p-4 border border-border rounded-xl bg-muted/20 text-center space-y-3">
                  <ScoreGauge label="Overall Partnership Score" score={computedOverallScore} sub="Very Good" size="large" />
                  ...
                  <div className="w-full">
                    ...
                    >
                      {[
                        ...
                        "Improve Integration Plan",
                        "Strengthen Governance",
                        "Expand Partnership Scope",
                        "Proceed to Partnership Launch",
                      ].map((rec) => (
            ...
            <div id="sec-attachments" className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-border">
                <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
                  <FileText className="h-4 w-4 text-primary" /> 10. Partnership Attachments & Artifacts
                </h3>
                <button
                  type="button"
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-primary/20 bg-gradient-to-b from-primary/5 via-card to-card p-5 shadow-xs space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5">
                    <Handshake className="h-3.5 w-3.5 text-blue-600" /> Best Partnership Type
                  </span>
                  <p className="text-muted-foreground leading-relaxed">
                    Technology Partnership shows 92% success rate in similar cases.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    AI predicts ₹ 120 Cr revenue potential in 3 years.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Medium risk identified. Monitor market volatility and integration delays.
                  </p>
                </div>

                <div className="rounded-lg border border-border bg-card p-3 space-y-1">
                  <span className="font-bold text-foreground flex items-center gap-1.5 text-indigo-600">
                    <Zap className="h-3.5 w-3.5" /> Synergy Score
                  </span>
                  <p className="text-muted-foreground leading-relaxed">
                    Strong synergy detected in technology and market expansion.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Sparkline data={[80, 95, 108, 120]} color="#10b981" />
                  </div>
                  <span className="text-base font-bold text-emerald-600 font-mono block">₹ 120 Cr</span>
                </div>

                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Investment</span>
                    <Sparkline data={[30, 40, 45, 50]} color="#2563eb" />
                  </div>
                  <span className="text-base font-bold text-foreground font-mono block">₹ 50 Cr</span>
                </div>

                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">ROI (3 Years)</span>
                    <Sparkline data={[180, 200, 220, 240]} color="#10b981" />
                  </div>
                  <span className="text-base font-bold text-emerald-600 font-mono block">240 %</span>
                </div>

                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Risk Score</span>
                    <Sparkline data={[82, 80, 78, 76]} color="#f43f5e" />
                  </div>
                  <span className="text-base font-bold text-amber-600 font-mono block">76 / 100</span>
                </div>
                ...
                <div className="rounded-lg border border-border bg-muted/20 p-3 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground font-semibold">Satisfaction Score</span>
                    <Sparkline data={[4.1, 4.3, 4.4, 4.6]} color="#2563eb" />
                  </div>
                  <span className="text-base font-bold text-foreground font-mono block">4.6 / 5</span>
                </div>
              </div>

              <button
                type="button"
                onClick={() => showToast("info", "KPI Dashboard", "Navigating to Partnership KPI Dashboard...")}
            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-xs space-y-3 text-xs">
              ...
              <div className="space-y-1.5 text-muted-foreground">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-foreground">{formData.partnershipManager}</span>
                </div>
                <div className="flex justify-between">
                  <span>Created Date:</span>
                  <span className="font-semibold text-foreground">05 May 2024 09:15 AM</span>
                </div>
                <div className="flex justify-between">
