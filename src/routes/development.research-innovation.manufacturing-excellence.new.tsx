...
const DEFAULT_EXCELLENCE_RECORD: ManufacturingExcellenceRecord = {
  ...
  processCapabilityCpCpk: "1.67 / 1.58",
  capaStatus: "In Progress",
  auditCompliance: 94.50,
  regulatoryCompliance: true,
  qualityExcellenceScore: 88,

  energyConsumptionPerUnit: 1.24,
  carbonEmissionsPerUnit: 0.68,
  waterConsumptionPerUnit: 2.35,
  wasteReductionPct: 18.60,
  recyclingRatePct: 72.30,
  esgComplianceVerified: true,
  ...
  reviewComments: "Overall initiative approved. Maintain TPM autonomous maintenance focus.",
  approvalDate: "14 May 2024",
