...
export const mockMarketingOverviewData: MarketingOverviewData = {
  ...
  submodules: [
    ...
    },
    {
      ...
      route: "/management/marketing-management/email-marketing",
      badge: "Nurture & Drip",
      badgeColor: "bg-cyan-500/10 text-cyan-600 border-cyan-500/20",
      description: "Automated sequences, newsletter broadcasts, segmentation & deliverability.",
      metric: "48.2% Open Rate",
    },
    {
      id: "mkt-mod-4",
      name: "Social Media",
      route: "/management/marketing-management/social-media",
      badge: "Omnichannel Social",
      badgeColor: "bg-pink-500/10 text-pink-600 border-pink-500/20",
      description: "LinkedIn, YouTube, X, Instagram and WhatsApp community publishing.",
    ...
    },
    {
      ...
      badgeColor: "bg-blue-500/10 text-blue-600 border-blue-500/20",
      description: "Brand guidelines, visual identity, trademarks, asset library & compliance governance.",
    ...
    },
    {
      ...
      route: "/management/marketing-management/competitor-analysis",
      badge: "Benchmarking",
      badgeColor: "bg-sky-500/10 text-sky-600 border-sky-500/20",
      description: "Competitor profiling, SWOT, product comparison, pricing & AI intelligence.",
      metric: "12 Tracked",
    },
    {
      id: "mkt-mod-10",
      name: "Marketing Analytics",
      route: "/management/marketing-management/marketing-analytics",
      badge: "BI & Attribution",
      badgeColor: "bg-purple-500/10 text-purple-600 border-purple-500/20",
      description: "Omnichannel analytics, multi-touch attribution, CAC/CLV & predictive modeling.",
      metric: "₹4.8 Cr Attributed",
    },
  ],
  recentActivities: [
